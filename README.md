...
```bash
git clone https://github.com/Lasha1a/Booking-System.git
cd Booking-System
```
...
**Option 2 — .NET CLI:**
```bash
dotnet ef migrations add InitialCreate --project BookingSystem.Persistence --startup-project BookingSystem
...
```bash
dotnet run --project BookingSystem
```
